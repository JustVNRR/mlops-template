...
# 2. Export the variables so they are available to the shell
export

# 3. Build the Service Account email dynamically
SA_EMAIL = $(SA_NAME)@$(GCP_PROJECT).iam.gserviceaccount.com

# 4. Import the sub-makefiles (logical MLOps order)
# include make/local.mk   # Step 1: create the local environment
# include make/gcp.mk
